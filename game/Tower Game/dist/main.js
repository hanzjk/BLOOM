! function(e) {
    ...
    function i(n) { if (t[n]) return t[n].exports; var a = t[n] = { i: n, l: !1, exports: {} }; return e[n].call(a.exports, a, a.exports, i), a.l = !0, a.exports }
    ...
    t.checkMoveDown = function(e) { return e.checkTimeMovement(n.moveDownMovement) };
    ...
    var a = function(e) { return e.checkTimeMovement(n.hookDownMovement) ? n.hookDown : e.checkTimeMovement(n.hookUpMovement) ? n.hookUp : n.hookNormal };
    t.getHookStatus = a;
    ...
    "use strict";
    Object.defineProperty(t, "__esModule", { value: !0 }), Object.defineProperty(t, "Engine", { enumerable: !0, get: function() { return n.default } }), Object.defineProperty(t, "Instance", { enumerable: !0, get: function() { return a.default } });
    var n = r(i(14)),
        a = r(i(11));
        ...
        if (i) {
            ...
            if (!n) {
                var s = function(e, t) {
                    ...
                    return { bottomToTop: { x: i * r(.3, .7), y: n, vx: 0, vy: .7 * e.pixelsPerFrame(n) * -1 }, leftToRight: { x: -1 * o, y: n * r(.3, .6), vx: .4 * e.pixelsPerFrame(i), vy: .1 * e.pixelsPerFrame(n) * -1 }, rightToLeft: { x: i, y: n * r(.2, .5), vx: .4 * e.pixelsPerFrame(i) * -1, vy: .1 * e.pixelsPerFrame(n) }, rightTopToLeft: { x: i, y: 0, vx: .6 * e.pixelsPerFrame(i) * -1, vy: .5 * e.pixelsPerFrame(n) } }[t]
                }(t, r);
    ...
    var r = function(e, t) { e.status === a.rotateLeft ? e.y - e.width >= t.height && (e.visible = !1, e.status = a.out, (0, n.addFailedCount)(t)) : e.y >= t.height && (e.visible = !1, e.status = a.out, (0, n.addFailedCount)(t)) };
        ...
        if (o.visible) {
            ...
            switch (o.status) {
                ...
                case a.drop:
                    ...
                    var l = function(e, t) { return e.y + e.height >= t.y ? e.x < t.x - e.calWidth || e.x > t.collisionX + e.calWidth ? 1 : e.x < t.x ? 2 : e.x > t.collisionX ? 3 : e.x > t.x + .8 * e.calWidth && e.x < t.x + 1.2 * e.calWidth ? 5 : 4 : 0 }(e, c),
                        d = c.y - e.height,
                        h = function(e) { e.originOutwardAngle = Math.atan(e.height / e.outwardOffset), e.originHypotenuse = Math.sqrt(Math.pow(e.height, 2) + Math.pow(e.outwardOffset, 2)), t.playAudio("rotate") };
                    switch (l) {
                        case 1:
                            r(e, t);
                            break;
                ...
                case a.land:
                    t.getTimeMovement(a.moveDownMovement, [
                        [e.y, e.y + (0, n.getMoveDownValue)(t, { pixelsPerFrame: function(e) { return e / 2 } })]
                    ], function(i) { e.visible && (e.y = i, e.y > t.height && (e.visible = !1)) }, { name: e.name }), e.x += (0, n.getLandBlockVelocity)(t, i);
                    break;
                case a.rotateLeft:
                case a.rotateRight:
    ...
    t.endAnimate = function(e) {
        if (e.getVariable(s.gameStartNow)) {
            ...
            (0, r.drawYellowString)(e, { string: "", size: .06 * e.width, x: .24 * e.width + a, y: .12 * e.width, textAlign: "left" }), (0, r.drawYellowString)(e, { string: t, size: .13 * e.width, x: .22 * e.width + a, y: .2 * e.width, textAlign: "right" });
            var o = e.getImg("score"),
                c = o.width,
                u = o.height,
                l = .35 * e.width,
                d = u * l / c;
            e.ctx.drawImage(o, .61 * e.width, .038 * e.width, l, d), (0, r.drawYellowString)(e, { string: n, size: .06 * e.width, x: .9 * e.width, y: .11 * e.width, textAlign: "right" });
    ...
    t.startAnimate = function(e) {
        if (e.getVariable(s.gameStartNow)) {
            ...
            if (!t || [s.land, s.out].indexOf(t.status) > -1) {
                ...
                var u = new n.Instance({ name: "block_".concat(e.getVariable(s.blockCount)), action: a.blockAction, painter: a.blockPainter });
                e.addInstance(u)
            }
    ...
    t.tutorialAction = function(e, t, i) {
        ...
        if (!e.ready) {
            e.ready = !0;
            var o = .2 * n;
            e.updateWidth(o), e.height = .86 * o, e.x = t.calWidth - e.calWidth, e.y = .15 * a, "tutorial" !== r && (e.y += 1.2 * e.height)
        }
    ...
    t.hookAction = function(e, t, i) {
        ...
        e.ready || (e.x = t.width / 2, e.y = -1.5 * r, e.ready = !0), t.getTimeMovement(a.hookUpMovement, [
            [e.y, e.y - r]
        ], function(t) { e.y = t }, { after: function() { e.y = -1.5 * r } }), t.getTimeMovement(a.hookDownMovement, [
            [e.y, e.y + r]
        ], function(t) { e.y = t }, { name: "hook" });
    ...
    var r = function(e) {
        var t = e.count,
            i = function(e) { return e[Math.floor(Math.random() * e.length)] };
    ...
    t.cloudAction = function(e, t) {
        if (!e.ready) {
            ...
            var i = t.width,
                o = t.height,
                s = [{ x: .1 * i, y: .66 * -o }, { x: .65 * i, y: .33 * -o }, { x: .1 * i, y: 0 }, { x: .65 * i, y: .33 * o }][e.index - 1];
    ...
    var r = function(e) {
        ...
        o > e.height || (e.getTimeMovement(a.moveDownMovement, [
            [o, o + (0, n.getMoveDownValue)(e, { pixelsPerFrame: function(e) { return e / 2 } })]
        ], function(e) { o = e }, { name: "background" }), e.getTimeMovement(a.bgInitMovement, [
            [o, o + r / 4]
        ], function(e) { o = e }), e.setVariable(a.bgImgOffset, o), e.setVariable(a.lineInitialOffset, e.height - .394 * r), e.ctx.drawImage(t, 0, o, e.width, r))
    };
    t.backgroundImg = r;
    var o = function(e, t, i) {
        ...
        s = function(e) {
            ...
            var d = function() { e.ctx.fillStyle = "rgba(255, 255, 255, 0.7)", e.ctx.fillRect(0, 0, e.width, e.height) };
            e.getTimeMovement(a.lightningMovement, [], function() {}, { before: d, after: d })
        };
    t.backgroundLinearGradient = s;
    t.background = function(e) { s(e), r(e) }
}, function(e, t, i) {
    "use strict";
    ...
    var a = function() {
        ...
        var t, i, a;
        return t = e, (i = [{ key: "paint", value: function(e) { null !== this.painter && this.visible && this.painter(this, e) } }, { key: "update", value: function(e, t) { null !== this.action && this.action(this, e, t) } }, { key: "updateWidth", value: function(e) { this.width = e, this.calWidth = e / 2 } }, { key: "updateHeight", value: function(e) { this.height = e, this.calHeight = e / 2 } }]) && n(t.prototype, i), a && n(t, a), e
    }();
    t.default = a
}, function(e, t, i) {
    "use strict";
    Object.defineProperty(t, "__esModule", { value: !0 }), t.default = void 0;
    var n = { linear: function(e, t, i, n) { return i * e / n + t }, easeIn: function(e, t, i, n) { return i * (e /= n) * e + t }, easeOut: function(e, t, i, n) { return -i * (e /= n) * (e - 2) + t }, easeInOut: function(e, t, i, n) { return (e /= n / 2) < 1 ? i / 2 * e * e + t : -i / 2 * (--e * (e - 2) - 1) + t } };
    t.default = n
}, function(e, t, i) {
    "use strict";
    ...
    var n = function() { return +new Date };
    t.getCurrentTime = n;
    t.random = function(e, t) { return Math.random() * (t - e) + e };
    t.randomPositiveNegative = function() { return Math.random() < .5 ? -1 : 1 };
    t.isFunction = function(e) { return "function" == typeof e };
    t.isTouchDevice = function() { return "ontouchstart" in window || window.navigator.msMaxTouchPoints };
    ...
    function o(e) { return function(e) { if (Array.isArray(e)) { for (var t = 0, i = new Array(e.length); t < e.length; t++) i[t] = e[t]; return i } }(e) || function(e) { if (Symbol.iterator in Object(e) || "[object Arguments]" === Object.prototype.toString.call(e)) return Array.from(e) }(e) || function() { throw new TypeError("Invalid attempt to spread non-iterable instance") }() }
    ...
    var c = a.requestAnimationFrameTool,
        ...
        d = function() {
            function e() {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                if (function(e, t) { if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function") }(this, e), document.createElement("canvas").getContext) {
                    var i = t.canvasId,
                        n = t.debug,
                        r = t.width,
                        o = t.height,
            ...
            return t = e, (i = [{
                ...
                value: function(e, t) {
                    ...
                    if (this.soundOn) {
                        ...
                        a.src = t, this.assetsObj.audio[e] = a, a.addEventListener("error", function() { i.assetsErrorQueue.push({ name: e, src: t, retry: n + 1, type: "audio" }) }, !1), a.load()
                    }
                }
            }, { key: "getAudio", value: function(e) { return this.assetsObj.audio[e] } }, {
                key: "playAudio",
                value: function(e) {
                    ...
                    if (this.soundOn) {
                        ...
                        if (i) {
                            if (i.play(), !t) return;
                            i.addEventListener("ended", function() { i.currentTime = 0, i.play() }, !1)
                        }
                    }
                }
            }, {
            ...
            }, { key: "setVariable", value: function(e, t) { this.customVariable[e] = t } }, {
                key: "getVariable",
                value: function(e) {
                ...
                value: function(e, t) {
                    ...
                    a.src = t, a.onload = function() { i.assetsObj.image[e] = a }, a.onerror = function() { i.assetsErrorQueue.push({ name: e, src: t, retry: n + 1, type: "image" }) }
                }
            }, { key: "getImg", value: function(e) { return this.assetsObj.image[e] } }, {
                key: "animate",
                value: function(e) {
                    var t = this,
                        i = e - this.pausedTime,
                        n = this;
                    this.paused ? setTimeout(function() { t.animate.call(n, i) }, 100) : (this.tick(i), this.clean(), this.startAnimate(this, i), this.paintUnderInstance(this), this.updateInstances(i), this.paintInstances(), this.paintAboveInstance(), this.endAnimate(this, i), this.tickTimeMovement(), this.debug && this.showFps(), this.debug && this.drawDebug(), c(function(e) { t.animate.call(n, e) }))
                }
            }, { key: "showFps", value: function() { this.ctx.save(), this.ctx.fillStyle = "red", this.ctx.font = "".concat(this.highResolution ? 32 : 16, "px Arial"), this.ctx.fillText("FPS: ".concat(this.fps.toFixed()), 5, this.highResolution ? 40 : 20), this.ctx.restore() } }, { key: "debugLineX", value: function(e) { this.debugArr.push({ type: "lineX", y: e }) } }, { key: "debugLineY", value: function(e) { this.debugArr.push({ type: "lineY", x: e }) } }, { key: "debugDot", value: function(e, t) { this.debugArr.push({ type: "dot", x: e, y: t }) } }, {
                key: "drawDebug",
                value: function() {
                    var e = this;
            ...
            }, { key: "drawDebugDot", value: function(e, t) { this.ctx.save(), this.ctx.fillStyle = "red", this.ctx.beginPath(), this.ctx.arc(e, t, 2, 0, 2 * Math.PI, !0), this.ctx.fill(), this.ctx.fillStyle = "white", this.ctx.beginPath(), this.ctx.arc(e, t, 1, 0, 2 * Math.PI, !0), this.ctx.fill(), this.ctx.restore() } }, { key: "tick", value: function(e) { this.updateFps(e), this.lastTime = e } }, { key: "updateFps", value: function(e) { 0 === this.lastTime ? this.fps = 60 : this.fps = 1e3 / (e - this.lastTime) } }, { key: "pixelsPerFrame", value: function(e) { return e / this.fps } }, {
                key: "tickTimeMovement",
                value: function() {
                    var e = this;
                    this.timeMovementStartArr.forEach(function(t) { e.timeMovement[t].processing = !0 }), this.timeMovementStartArr = [], this.timeMovementFinishArr.forEach(function(t) { delete e.timeMovement[t] }), this.timeMovementFinishArr = []
                }
            }, {
                key: "getTimeMovement",
                value: function(e, t, i) {
                    ...
                    if (l) {
                        l.processing || ("hook" === a.name && console.log(t), this.timeMovementStartArr.push(e), l.store[u] = [], t.forEach(function(e) { l.store[u].push({ start: parseFloat(e[0]), end: parseFloat(e[1]) }) }), o && o());
                        var d = function() {
                            ...
                            var s = l.store[u].map(function(e) { return c(a, e.start, e.end - e.start, t) });
                            i.apply(n, s)
                        };
                        this.checkTimeMovement(e) ? d() : (this.timeMovementFinishArr.push(e), d(!0), s && s())
                    }
                }
            }, { key: "checkTimeMovement", value: function(e) { var t = this.timeMovement[e] || {}; return this.utils.getCurrentTime() <= t.endTime } }, {
                key: "setTimeMovement",
                value: function(e, t) {
                    var i = this.utils.getCurrentTime();
                    this.timeMovement[e] = { startTime: i, endTime: i + t, duration: t, store: {} }
                }
            }, { key: "clean", value: function() { this.ctx.clearRect(0, 0, this.width, this.height), this.debugArr = [] } }, { key: "addLayer", value: function(e) { this.layerArr.push(e), this.instancesObj[e] = [] } }, { key: "removeLayer", value: function(e) { this.layerArr = this.layerArr.filter(function(t) { return t !== e }), delete this.instancesObj[e] } }, { key: "swapLayer", value: function(e, t) { this.utils.arraySwap(this.layerArr, e, t) } }, {
                key: "addInstance",
                value: function(e) {
                    var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.defaultLayer;
                    this.instancesObj[t].push(e)
                }
            }, { key: "getInstance", value: function(e) { var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.defaultLayer; return this.instancesObj[t].filter(function(t) { return t.name === e })[0] } }, {
                key: "removeInstance",
                value: function(e) {
                    var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.defaultLayer;
                    this.getInstance(e, t) && (this.instancesObj[t] = this.instancesObj[t].filter(function(t) { return t.name !== e }))
                }
            }, {
                key: "updateInstances",
                value: function(e) {
                    var t = this;
                    this.layerArr.forEach(function(i) { t.instancesObj[i].forEach(function(i) { i.update && i.update(t, e) }) })
                }
            }, {
                key: "paintInstances",
                value: function() {
                    var e = this;
                    this.layerArr.forEach(function(t) { e.instancesObj[t].forEach(function(t) { t.paint && t.paint(e) }) })
                }
            }, {
                key: "togglePaused",
                value: function() {
            ...
            }, { key: "addKeyUpListener", value: function(e, t) { this.keyUpListeners[e] = t } }, { key: "addKeyDownListener", value: function(e, t) { this.keyDownListeners[e] = t } }, { key: "addKeyPressListener", value: function(e, t) { this.keyPressListeners[e] = t } }, { key: "findKeyListener", value: function(e, t) { return "keyup" === t ? this.keyUpListeners[e] : "keydown" === t ? this.keyDownListeners[e] : this.keyPressListeners[e] } }, {
                key: "keyListener",
                value: function(e, t) {
                    var i;
                    switch (e.keyCode) {
                ...
                value: function(e, t) {
                    var i = this,
                        n = setInterval(function() {
                            ...
                            t && u(t) && t({ success: r, failed: i.assetsErrorCount, total: a }), i.assetsErrorQueue.length > 0 && (i.assetsErrorQueue.forEach(function(e) {
                                var t = e.retry,
                                    n = e.name,
                                    a = e.src,
                                    r = e.type;
                ...
                value: function() {
                    var e = this,
                        t = this;
                    c(function(i) { e.animate.call(t, i) })
                }
    ...
    window.TowerGame = function() {
        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
            ...
            h = e.canvasId,
            g = e.soundOn,
            f = new n.Engine({ canvasId: h, highResolution: !0, width: t, height: i, soundOn: g }),
            v = function(e) { return "./assets/".concat(e) };
        ...
        return f.addInstance(k), f.startAnimate = d.startAnimate, f.endAnimate = d.endAnimate, f.paintUnderInstance = r.background, f.addKeyDownListener("enter", function() { f.debug && f.togglePaused() }), f.touchStartListener = function() {
            (0, a.touchEventHandler)(f)
        }, f.playBgm = function() { f.playAudio("bgm", !0) }, f.pauseBgm = function() { f.pauseAudio("bgm") }, f.start = function() {
